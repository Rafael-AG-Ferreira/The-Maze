...
(function(f) {
  ...
  return function e(t, n, r) {
    ...
    Font.prototype.hasChar = function(e) {
      ...
      t = t !== void 0 ? t : 0, n = n !== void 0 ? n : 0, i = i !== void 0 ? i : 72, r = r || {};
      for (var s = r.kerning === void 0 ? true : r.kerning, a = 1 / this.unitsPerEm * i, h = this.stringToGlyphs(e), u = 0; u < h.length; u += 1) {
        var c = h[u];
    ...
    Glyph.prototype.bindConstructorValues = function(t) {
      ...
      t = t !== void 0 ? t : 0, i = i !== void 0 ? i : 0, n = n !== void 0 ? n : { xScale: 1, yScale: 1 }, e = e !== void 0 ? e : 72;
      for (var a = 1 / this.path.unitsPerEm * e, h = n.xScale * a, o = n.yScale * a, r = new path.Path(), s = this.path.commands, p = 0; p < s.length; p += 1) {
        var y = s[p];
        y.type === "M" ? r.moveTo(t + y.x * h, i + -y.y * o) : y.type === "L" ? r.lineTo(t + y.x * h, i + -y.y * o) : y.type === "Q" ? r.quadraticCurveTo(t + y.x1 * h, i + -y.y1 * o, t + y.x * h, i + -y.y * o) : y.type === "C" ? r.curveTo(t + y.x1 * h, i + -y.y1 * o, t + y.x2 * h, i + -y.y2 * o, t + y.x * h, i + -y.y * o) : y.type === "Z" && r.closePath();
      }
      return r;
      ...
      return check.argument(i.length === 0, "There are still points left in the current contour."), t;
    }, Glyph.prototype.getMetrics = function() {
      for (var t = this.path.commands, i = [], e = [], n = 0; n < t.length; n += 1) {
        var a = t[n];
        a.type !== "Z" && (i.push(a.x), e.push(a.y)), (a.type === "Q" || a.type === "C") && (i.push(a.x1), e.push(a.y1)), a.type === "C" && (i.push(a.x2), e.push(a.y2));
      }
      ...
      i = i !== void 0 ? i : 0, e = e !== void 0 ? e : 0, n = n !== void 0 ? n : 24;
      for (var h = 1 / this.path.unitsPerEm * n, o = [], r = [], s = this.path, p = 0; p < s.commands.length; p += 1) {
        var y = s.commands[p];
        y.x !== void 0 && o.push({ x: y.x, y: -y.y }), y.x1 !== void 0 && r.push({ x: y.x1, y: -y.y1 }), y.x2 !== void 0 && r.push({ x: y.x2, y: -y.y2 });
      }
      t.fillStyle = "blue", a(o, i, e, h), t.fillStyle = "red", a(r, i, e, h);
    }, Glyph.prototype.drawMetrics = function(t, i, e, n) {
      var a;
      i = i !== void 0 ? i : 0, e = e !== void 0 ? e : 0, n = n !== void 0 ? n : 24, a = 1 / this.path.unitsPerEm * n, t.lineWidth = 1, t.strokeStyle = "black", draw.line(t, i, -1e4, i, 1e4), draw.line(t, -1e4, e, 1e4, e);
    ...
    var check = require2("./check"), Layout = { searchTag, binSearch, getScriptNames: function() {
      ...
      if (s) {
        ...
        if (a) {
          var o = i.length;
          return check.assert(o === 0 || t >= i[o - 1].tag, "Features must be added in alphabetical order."), n = { tag: t, feature: { params: 0, lookupListIndexes: [] } }, i.push(n), u.push(o), n.feature;
        }
      }
    ...
    function loadFromUrl(e, a) {
      ...
      r.open("get", e, true), r.responseType = "arraybuffer", r.onload = function() {
        return r.status !== 200 ? a("Font could not be loaded: " + r.statusText) : a(null, r.response);
      }, r.send();
    }
    ...
    function parseBuffer(e) {
      ...
      if (t.tables.name = _name.parse(q.data, q.offset, r), t.names = t.tables.name, i && g) {
        var k = a === 0, w = uncompressTable(n, g), x = loca.parse(w.data, w.offset, t.numGlyphs, k), O = uncompressTable(n, i);
    ...
    function load(e, a) {
      var r = typeof window == "undefined", s = r ? loadFromFile : loadFromUrl;
      s(e, function(e2, r2) {
        if (e2)
          return a(e2);
        var s2;
    ...
    Parser.prototype.parseByte = function() {
      ...
      r === void 0 && (r = 1), this.relativeOffset += typeOffsets[t] * r;
      ...
      return r === 1 ? { format: 1, startGlyph: this.parseUShort(), classes: this.parseUShortList() } : r === 2 ? { format: 2, ranges: this.parseRecordList({ start: Parser.uShort, end: Parser.uShort, classId: Parser.uShort }) } : void check.assert(false, "0x" + t.toString(16) + ": ClassDef format must be 1 or 2.");
    ...
    Path.prototype.moveTo = function(t, o) {
      ...
      for (var o = 0; o < this.commands.length; o += 1) {
        ...
        e.type === "M" ? t.moveTo(e.x, e.y) : e.type === "L" ? t.lineTo(e.x, e.y) : e.type === "C" ? t.bezierCurveTo(e.x1, e.y1, e.x2, e.y2, e.x, e.y) : e.type === "Q" ? t.quadraticCurveTo(e.x1, e.y1, e.x, e.y) : e.type === "Z" && t.closePath();
      }
      ...
      for (var i = "", s = 0; s < this.commands.length; s += 1) {
        ...
        h.type === "M" ? i += "M" + e(h.x, h.y) : h.type === "L" ? i += "L" + e(h.x, h.y) : h.type === "C" ? i += "C" + e(h.x1, h.y1, h.x2, h.y2, h.x, h.y) : h.type === "Q" ? i += "Q" + e(h.x1, h.y1, h.x, h.y) : h.type === "Z" && (i += "Z");
      }
      return i;
    }, Path.prototype.toSVG = function(t) {
      var o = '<path d="';
      return o += this.toPathData(t), o += '"', this.fill && this.fill !== "black" && (o += this.fill === null ? ' fill="none"' : ' fill="' + this.fill + '"'), this.stroke && (o += ' stroke="' + this.stroke + '" stroke-width="' + this.strokeWidth + '"'), o += "/>";
    }, exports3.Path = Path;
    ...
    Substitution.prototype = Layout, Substitution.prototype.getGsubTable = function(t) {
      ...
      check.assert(o.coverage.format === 1, "Ligature: unable to modify coverage table format " + o.coverage.format);
      ...
      o || (o = { substFormat: 1, coverage: { format: 1, glyphs: [] }, ligatureSets: [] }, s.subtables[0] = o), check.assert(o.coverage.format === 1, "Ligature: unable to modify coverage table format " + o.coverage.format);
      ...
      switch (t) {
        case "aalt":
        case "salt":
          return typeof e.by == "number" ? this.addSingle(t, e, r, a) : this.addAlternate(t, e, r, a);
        case "dlig":
        case "liga":
        case "rlig":
    ...
    function Coverage(e) {
      e.format === 1 ? Table.call(this, "coverageTable", [{ name: "coverageFormat", type: "USHORT", value: 1 }].concat(ushortList("glyph", e.glyphs))) : check.assert(false, "Can't create coverage table format 2 yet.");
    }
    ...
    function entriesToObject(e) {
      for (var t = {}, a = 0; a < e.length; a += 1) {
        ...
        if (r = s.length === 1 ? s[0] : s, t.hasOwnProperty(n))
    ...
    function parseCFFDict(e, t, a) {
      ...
      for (a = a !== void 0 ? a : e.length; r.relativeOffset < a; ) {
        var i = r.parseByte();
        21 >= i ? (i === 12 && (i = 1200 + r.parseByte()), n.push([i, s]), s = []) : s.push(parseOperand(r, i));
      }
    ...
    function interpretDict(e, t, a) {
      for (var r = {}, n = 0; n < t.length; n += 1) {
        var s = t[n], i = e[s.op];
        i === void 0 && (i = s.value !== void 0 ? s.value : null), s.type === "SID" && (i = getCFFString(a, i)), r[s.name] = i;
      }
      return r;
    }
        ...
        for (var y, b, C, T, F, I, D, x, k, S, E, O, R = 0; R < a2.length; ) {
          ...
          switch (R += 1, M) {
            ...
            case 5:
              ...
              break;
            case 6:
              for (; u.length > 0 && (v += u.shift(), p.lineTo(v, m), u.length !== 0); )
                m += u.shift(), p.lineTo(v, m);
              break;
            case 7:
              for (; u.length > 0 && (m += u.shift(), p.lineTo(v, m), u.length !== 0); )
            ...
            case 29:
              ...
              break;
            case 30:
              for (; u.length > 0 && (i = v, o = m + u.shift(), h = i + u.shift(), f = o + u.shift(), v = h + u.shift(), m = f + (u.length === 1 ? u.shift() : 0), p.curveTo(i, o, h, f, v, m), u.length !== 0); )
                i = v + u.shift(), o = m, h = i + u.shift(), f = o + u.shift(), m = f + u.shift(), v = h + (u.length === 1 ? u.shift() : 0), p.curveTo(i, o, h, f, v, m);
              break;
            case 31:
              for (; u.length > 0 && (i = v + u.shift(), o = m, h = i + u.shift(), f = o + u.shift(), m = f + u.shift(), v = h + (u.length === 1 ? u.shift() : 0), p.curveTo(i, o, h, f, v, m), u.length !== 0); )
                i = v, o = m + u.shift(), h = i + u.shift(), f = o + u.shift(), v = h + u.shift(), m = f + (u.length === 1 ? u.shift() : 0), p.curveTo(i, o, h, f, v, m);
              break;
            default:
    ...
    function parseCFFTable(e, t, a) {
      ...
      if (a.defaultWidthX = u.defaultWidthX, a.nominalWidthX = u.nominalWidthX, u.subrs !== 0) {
      ...
      a.cffEncoding = f.encoding === 0 ? new encoding.CffEncoding(encoding.cffStandardEncoding, g) : f.encoding === 1 ? new encoding.CffEncoding(encoding.cffExpertEncoding, g) : parseCFFEncoding(e, t + f.encoding, g), a.encoding = a.encoding || a.cffEncoding, a.glyphs = new glyphset.GlyphSet(a);
    ...
    function makeDict(e, t, a) {
      for (var r = {}, n = 0; n < e.length; n += 1) {
        ...
        i === void 0 || equals(i, s.value) || (s.type === "SID" && (i = encodeString(i, a)), r[s.op] = { name: s.name, type: s.type, value: i });
      }
      return r;
    }
    ...
    function parseCmapTableFormat4(e, a, r, t, n) {
      ...
      for (s = 0; o - 1 > s; s += 1)
        for (var h, f = l.parseUShort(), c = p.parseUShort(), d = g.parseShort(), i = m.parseUShort(), v = c; f >= v; v += 1)
          i !== 0 ? (u = m.offset + m.relativeOffset - 2, u += i, u += 2 * (v - c), h = parse.getUShort(r, u), h !== 0 && (h = h + d & 65535)) : h = v + d & 65535, e.glyphIndexMap[v] = h;
    }
    function parseCmapTable(e, a) {
      var r, t = {};
      t.version = parse.getUShort(e, a), check.argument(t.version === 0, "cmap table version should be 0."), t.numTables = parse.getUShort(e, a + 2);
      var n = -1;
      ...
      if (t.format = l.parseUShort(), t.format === 12)
    ...
    function makeCmapTable(e) {
      ...
      for (a = 0; s > a; a += 1) {
        var u = r.segments[a];
        o = o.concat({ name: "end_" + a, type: "USHORT", value: u.end }), l = l.concat({ name: "start_" + a, type: "USHORT", value: u.start }), p = p.concat({ name: "idDelta_" + a, type: "SHORT", value: u.delta }), g = g.concat({ name: "idRangeOffset_" + a, type: "USHORT", value: u.offset }), u.glyphId !== void 0 && (m = m.concat({ name: "glyph_" + a, type: "USHORT", value: u.glyphId }));
      }
    ...
    function parseFvarTable(e, a, r) {
      ...
      check.argument(t === 65536, "Unsupported fvar table version.");
    ...
    function parseGlyphCoordinate(e, r, t, o, a) {
      var n;
      return (r & o) > 0 ? (n = e.parseByte(), (r & a) === 0 && (n = -n), n = t + n) : n = (r & a) > 0 ? t : t + e.parseShort(), n;
    }
    ...
    function getContours(e) {
      ...
      return check.argument(t.length === 0, "There are still points left in the current contour."), r;
    }
    function getPath(e) {
      var r = new path.Path();
      if (!e)
    ...
    function parseGposTable(r, e, a) {
      ...
      check.argument(t === 1, "Unsupported GPOS table version."), parseTaggedListTable(r, e + s.parseUShort()), parseTaggedListTable(r, e + s.parseUShort());
      var o = s.parseUShort();
      s.relativeOffset = o;
      for (var p = s.parseUShort(), n = s.parseOffset16List(p), f = e + o, i = 0; p > i; i++) {
        var h = parseLookupTable(r, f + n[i]);
        h.lookupType !== 2 || a.getGposKerningValue || (a.getGposKerningValue = h.getKerningValue);
      }
    }
    ...
    function parseGsubTable(e, t) {
      ...
      return check.argument(r === 1, "Unsupported GSUB table version."), { version: r, scripts: s.parseScriptList(), features: s.parseFeatureList(), lookups: s.parseLookupList(subtableParsers) };
    }
    ...
    subtableParsers[1] = function() {
      ...
      return t === 1 ? { substFormat: 1, coverage: this.parsePointer(Parser.coverage), deltaGlyphId: this.parseUShort() } : t === 2 ? { substFormat: 2, coverage: this.parsePointer(Parser.coverage), substitute: this.parseOffset16List() } : void check.assert(false, "0x" + e.toString(16) + ": lookup type 1 format must be 1 or 2.");
    }, subtableParsers[2] = function() {
      var e = this.parseUShort();
      return check.argument(e === 1, "GSUB Multiple Substitution Subtable identifier-format must be 1"), { substFormat: e, coverage: this.parsePointer(Parser.coverage), sequences: this.parseListOfLists() };
    }, subtableParsers[3] = function() {
      var e = this.parseUShort();
      return check.argument(e === 1, "GSUB Alternate Substitution Subtable identifier-format must be 1"), { substFormat: e, coverage: this.parsePointer(Parser.coverage), alternateSets: this.parseListOfLists() };
    }, subtableParsers[4] = function() {
      var e = this.parseUShort();
      return check.argument(e === 1, "GSUB ligature table identifier-format must be 1"), { substFormat: e, coverage: this.parsePointer(Parser.coverage), ligatureSets: this.parseListOfLists(function() {
    ...
    subtableParsers[5] = function() {
      ...
      var e = this.offset + this.relativeOffset, t = this.parseUShort();
      return t === 1 ? { substFormat: 1, coverage: this.parsePointer(Parser.coverage), chainRuleSets: this.parseListOfLists(function() {
      ...
      }) } : t === 2 ? { substFormat: 2, coverage: this.parsePointer(Parser.coverage), backtrackClassDef: this.parsePointer(Parser.classDef), inputClassDef: this.parsePointer(Parser.classDef), lookaheadClassDef: this.parsePointer(Parser.classDef), chainClassSet: this.parseListOfLists(function() {
        return { backtrack: this.parseUShortList(), input: this.parseUShortList(this.parseShort() - 1), lookahead: this.parseUShortList(), lookupRecords: this.parseRecordList(lookupRecordDesc) };
      }) } : t === 3 ? { substFormat: 3, backtrackCoverage: this.parseList(Parser.pointer(Parser.coverage)), inputCoverage: this.parseList(Parser.pointer(Parser.coverage)), lookaheadCoverage: this.parseList(Parser.pointer(Parser.coverage)), lookupRecords: this.parseRecordList(lookupRecordDesc) } : void check.assert(false, "0x" + e.toString(16) + ": lookup type 6 format must be 1, 2 or 3.");
    }, subtableParsers[7] = function() {
      var e = this.parseUShort();
      check.argument(e === 1, "GSUB Extension Substitution subtable identifier-format must be 1");
      ...
      var e = this.parseUShort();
      return check.argument(e === 1, "GSUB Reverse Chaining Contextual Single Substitution Subtable identifier-format must be 1"), { substFormat: e, coverage: this.parsePointer(Parser.coverage), backtrackCoverage: this.parseList(Parser.pointer(Parser.coverage)), lookaheadCoverage: this.parseList(Parser.pointer(Parser.coverage)), substitutes: this.parseUShortList() };
    };
    var subtableMakers = new Array(9);
    subtableMakers[1] = function(e) {
      return e.substFormat === 1 ? new table.Table("substitutionTable", [{ name: "substFormat", type: "USHORT", value: 1 }, { name: "coverage", type: "TABLE", value: new table.Coverage(e.coverage) }, { name: "deltaGlyphID", type: "USHORT", value: e.deltaGlyphId }]) : new table.Table("substitutionTable", [{ name: "substFormat", type: "USHORT", value: 2 }, { name: "coverage", type: "TABLE", value: new table.Coverage(e.coverage) }].concat(table.ushortList("substitute", e.substitute)));
    }, subtableMakers[3] = function(e) {
      return check.assert(e.substFormat === 1, "Lookup type 3 substFormat must be 1."), new table.Table("substitutionTable", [{ name: "substFormat", type: "USHORT", value: 1 }, { name: "coverage", type: "TABLE", value: new table.Coverage(e.coverage) }].concat(table.tableList("altSet", e.alternateSets, function(e2) {
        return new table.Table("alternateSetTable", table.ushortList("alternate", e2));
      })));
    }, subtableMakers[4] = function(e) {
      return check.assert(e.substFormat === 1, "Lookup type 4 substFormat must be 1."), new table.Table("substitutionTable", [{ name: "substFormat", type: "USHORT", value: 1 }, { name: "coverage", type: "TABLE", value: new table.Coverage(e.coverage) }].concat(table.tableList("ligSet", e.ligatureSets, function(e2) {
    ...
    function parseKernTable(r, e) {
      ...
      check.argument(p === 0, "Unsupported kern table version."), s.skip("uShort", 1);
      var t = s.parseUShort();
      check.argument(t === 0, "Unsupported kern sub-table version."), s.skip("uShort", 2);
      var o = s.parseUShort();
      s.skip("uShort", 3);
      for (var n = 0; o > n; n += 1) {
    ...
    function parseLtagTable(e, a) {
      ...
      check.argument(t === 1, "Unsupported ltag table version."), r.skip("uLong", 1);
    ...
    function parseMetaTable(e, a) {
      var r = new parse.Parser(e, a), t = r.parseULong();
      check.argument(t === 1, "Unsupported META table version."), r.parseULong(), r.parseULong();
      ...
      for (var n = {}, t = new parse.Parser(e, a), s = t.parseUShort(), m = t.parseUShort(), i = t.offset + t.parseUShort(), c = 0; m > c; c++) {
        ...
        if (v !== void 0 && h !== void 0) {
          ...
          if (x = v === utf16 ? decode.UTF16(e, i + p, f) : decode.MACSTRING(e, i + p, f, v)) {
            var y = n[d];
            y === void 0 && (y = n[d] = {}), y[h] = x;
          }
        }
      }
      var b = 0;
      return s === 1 && (b = t.parseUShort()), n;
    }
    ...
    function makeNameTable(e, a) {
      ...
      for (var m in e) {
        var i = s[m];
        if (i === void 0 && (i = m), r = parseInt(i), isNaN(r))
      ...
      for (var c = reverseDict(macLanguages), o = reverseDict(windowsLanguages), u = [], l = [], g = 0; g < n.length; g++) {
        ...
        for (var f in d) {
          ...
          b === void 0 && (h = 0, v = a.indexOf(f), 0 > v && (v = a.length, a.push(f)), x = 4, b = encode.UTF16(p));
    ...
    function makeTableRecord(e, a, n, t) {
      return new table.Record("Table Record", [{ name: "tag", type: "TAG", value: e !== void 0 ? e : "" }, { name: "checkSum", type: "ULONG", value: a !== void 0 ? a : 0 }, { name: "offset", type: "ULONG", value: n !== void 0 ? n : 0 }, { name: "length", type: "ULONG", value: t !== void 0 ? t : 0 }]);
    }
    function makeSfntTable(e) {
      ...
      for (var s = 0; s < e.length; s += 1) {
        var l = e[s];
        check.argument(l.tableName.length === 4, "Table name" + l.tableName + " is invalid.");
    ...
    encode.BYTE = function(e) {
      ...
      return check.argument(e.length === 4, "Tag should be exactly 4 ASCII characters."), [e.charCodeAt(0), e.charCodeAt(1), e.charCodeAt(2), e.charCodeAt(3)];
    ...
    var macEncodingTableCache = typeof WeakMap == "function" && /* @__PURE__ */ new WeakMap(), macEncodingCacheKeys, getMacEncodingTable = function(e) {
    ...
    encode.CHARSTRING = function(e) {
      ...
      var n = encode[e.type];
      return check.argument(n !== void 0, "No encoding function for type " + e.type), n(e.value);
    }, sizeOf.OBJECT = function(e) {
      var n = sizeOf[e.type];
      return check.argument(n !== void 0, "No sizeOf function for type " + e.type), n(e.value);
    }, encode.TABLE = function(e) {
      var n, t = [], o = e.fields.length, c = [], r = [];
      for (n = 0; o > n; n += 1) {
        var i = e.fields[n], a = encode[i.type];
        check.argument(a !== void 0, "No encoding function for field type " + i.type + " (" + i.name + ")");
        var f = e[i.name];
        f === void 0 && (f = i.value);
        var d = a(f);
        i.type === "TABLE" ? (r.push(t.length), t = t.concat([0, 0]), c.push(d)) : t = t.concat(d);
      }
      ...
      for (var n = 0, t = e.fields.length, o = 0; t > o; o += 1) {
        ...
        check.argument(r !== void 0, "No sizeOf function for field type " + c.type + " (" + c.name + ")");
        var i = e[c.name];
        i === void 0 && (i = c.value), n += r(i), c.type === "TABLE" && (n += 2);
      }
      return n;
